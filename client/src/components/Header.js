        ...
        <>
          ...
          <Navbar.Collapse id="responsive-navbar-nav" className="justify-content-end">
            <Nav >
              ...
              <Nav.Link as={Link} to="/practice" eventKey="2">Guide</Nav.Link>
              <Nav.Link as={Link} to="/history" eventKey="3">History</Nav.Link>
              <Nav.Link as={Link} to="/predict" eventKey="4">Fitness Prediction</Nav.Link>
